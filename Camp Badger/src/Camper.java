...
public class Camper implements Comparable<Camper> {
  ...
  private String firstName; // Camper First Name
  private String lastName; // camper last name
  private int age; // camper age
  private String cabin; // which cabin the camper is assigned based on age
  ...
  public int compareTo(Camper camper) {
    ...
    String s1 = this.lastName + ", " + this.firstName; // Combining both first and last name of this
                                                       // camper
    String s2 = camper.lastName + ", " + camper.firstName; // combined full name of camper being
                                                           // compared to
